  ...
  return <Box>
    ...
    <FormGroup>
      ...
      <FormControl>
        ...
        />
        <FormHelperText>Если отмечено, то при ответе на вопрос пользователь может выбрать только один
          вариант</FormHelperText>
      </FormControl>
      <FormControl>
        <FormControlLabel
          control={<Checkbox
        ...
        />
        <FormHelperText>Если отмечено, то варианты в процессе прохождения будут выведены в случайной
          последовательности</FormHelperText>
      </FormControl>
    </FormGroup>
  </Box>
}