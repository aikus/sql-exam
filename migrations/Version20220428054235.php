...
final class Version20220428054235 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE result_table result_table LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:array)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE answer CHANGE result_table result_table LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:object)\'');
